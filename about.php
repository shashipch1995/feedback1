...
<!-- Navigation -->
       <div class="row">
        ...
        <!-- Intro Content -->
        <div class="row" style="margin-bottom:100px;margin-left:100px">
...
We can start the development from the login page, where we have given the option to login as admin and student..
Here since we have only one admin account, so no need to create the a database to store admin info. so the admin username is "admin" and password is "admin"...select admin in the radio button and login 
